...
import { User, MenuItem, TiffinItem } from './models';
...
export async function seedAdmin() {
  ...
  await (User as any).findOneAndUpdate(
    { role: 'admin' },
    { name: 'Restaurant Admin', contact: adminUsername.toLowerCase(), password: hashedPassword },
...
export async function seedTiffin() {

...
// Delivery charge temporarily disabled — returns free delivery always.
// To re-enable: restore the Borzo API call below and remove this early return.
export async function POST() {
  return NextResponse.json({ success: true, deliveryFee: 0, estimatedTime: 'Free delivery' });
}